...
namespace Restaurant.Web.Areas.Demos.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderDate,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,CustomerId,ItemId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderDate,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,CustomerId,ItemId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
